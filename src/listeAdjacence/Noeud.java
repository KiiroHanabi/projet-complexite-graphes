...
public class Noeud {
	...
	/**
	 * Ajoute un nouvel arc vers un noeud successeur, en vérifiant qu'il n'y en
	 * a pas déjà un.
	 * 
	 * @param suc
	 *            : Noeud successeur.
	 * @param poids
	 *            : Poids de l'arc.
	 * @return <strong>false</strong> si il y a déjà un arc,
	 *         <strong>true</strong> si l'ajout s'est bien passé.
	 */
	...
	/**
	 * Recherche un arc dans la liste dont le successeur est
	 * <strong>term</strong>.
	 * 
	 * @param term
	 *            : le successeur de l'arc à rechercher.
	 * @return l'arc recherché s'il existe, <strong>null</strong> dans le cas
	 *         contraire.
	 */
