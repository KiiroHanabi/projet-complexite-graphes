...
public class TSP {
	 ...
	 * 
	 * @param n Le nombre de points du circuit.
	 */
	 ...
	 * 
	 * @param list Le circuit dont on veut calculer la distance.
	 ...
	 * 
	 * @param list Le circuit à améliorer.
	 * @return Le circuit amélioré.
	 */
	 ...
	 * 
	 * @param a L'index du début du segment.
	 * @param b L'index de la fin du segment.
	 * @param list Le circuit à améliorer.
	 * @return Le circuit amélioré.
	 */
	public static ArrayList<Point> reverseSegment(int a, int b, ArrayList<Point> list) {
